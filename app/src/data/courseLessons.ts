...
function lesson(input: LessonAuthoringInput): CourseLesson {
  return {
    ...
    podcastStatus: ["B1.1","B1.2","B1.3","B1.4","B1.5","B2.1","B2.2","B2.3","B3.1","B3.2","A1.1","A1.2","A1.3","A1.4","A1.5","A1.6","A2.1","A2.2","A2.3","A3.1","A3.2"].includes(input.id) ? "script-ready" : "authoring",
    platformCommands: {
      macos: input.command,
      linux: input.command,
      windows: "Use the Windows adapter for the same observation."
